  ...
  return (
    pageData.content.map((data, index) => (
      <div key={index} 
          ...
          <div className="hero-item relative w-full" style={{ backgroundImage: `url(${data.image.large.url})` }}>
            
          </div>

          <div className="hero-content absolute top-20 left-0 p-8 md:p-0 md:h-[500px] md:ml-[60px] md:mt-[90px]">
                <h2
